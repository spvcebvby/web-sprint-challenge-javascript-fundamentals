...
// it can access this because internal and nestedFunction are both in the same function scope
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lessThanFive = array.filter(zooAnimals => zooAnimals.population < 5)
    //const animalNames = lessThanFive.map(zooAnimals => zooAnimals.name);
    return lessThanFive;
  }
  ...
  */
  ...
  function USApop(array){
    const findPopulation = array.map(item => item.population)
    const sumOfAnimals = findPopulation.reduce(
 ...
 //console.log(consume(10,5,subtract))
...
console.log(greeting('Nikki','Zapata'))
...
const cuboidTwo = new CuboidMakerTwo(obj2)
